...
//            cout << "wheel Jacabian sx: " << jacobian.block<3,1>(0,0).transpose() << endl;
//            cout << "vel0 and vel1: " << (delta_q.toRotationMatrix() * I1 * _vel_0 + result_delta_q.toRotationMatrix() * I1 * _vel_1).transpose() << endl;
...
//            cout << "wheel Jacabian sy: " << jacobian.block<3,1>(0,1).transpose() << endl;
